...
g.server({ id: 1073741932 }).on('whenEntityIsCreated', (_evt, f) => {
  ...
  f.setCustomVariable(f.getSelfEntity(), '38', [39, 40, 41], false)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '115',
    f.assemblyList([116n, 117n, 118n], 'config_id'),
    true
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '124',
    f.assemblyList([125n, 126n, 127n], 'faction'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '128',
    f.assemblyList([129.25, 130.25, 131.25], 'float'),
    false
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '156', [157, 158, 159], false)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '192',
    f.assemblyList([193n, 194n, 195n], 'config_id'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '205',
    f.assemblyList([206.25, 207.25, 208.25], 'float'),
    true
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '233', [234, 235, 236], true)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '269',
    f.assemblyList([270n, 271n, 272n], 'config_id'),
    true
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '278',
    f.assemblyList([279n, 280n, 281n], 'faction'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '282',
    f.assemblyList([283.25, 284.25, 285.25], 'float'),
    false
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '310', [311, 312, 313], false)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '346',
    f.assemblyList([347n, 348n, 349n], 'config_id'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '359',
    f.assemblyList([360.25, 361.25, 362.25], 'float'),
    true
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '387', [388, 389, 390], true)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '423',
    f.assemblyList([424n, 425n, 426n], 'config_id'),
    true
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '432',
    f.assemblyList([433n, 434n, 435n], 'faction'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '436',
    f.assemblyList([437.25, 438.25, 439.25], 'float'),
    false
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '464', [465, 466, 467], false)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '500',
    f.assemblyList([501n, 502n, 503n], 'config_id'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '513',
    f.assemblyList([514.25, 515.25, 516.25], 'float'),
    true
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '541', [542, 543, 544], true)
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '577',
    f.assemblyList([578n, 579n, 580n], 'config_id'),
    true
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '586',
    f.assemblyList([587n, 588n, 589n], 'faction'),
    false
  )
  ...
  f.setCustomVariable(
    f.getSelfEntity(),
    '590',
    f.assemblyList([591.25, 592.25, 593.25], 'float'),
    false
  )
  ...
  f.setCustomVariable(f.getSelfEntity(), '618', [619, 620, 621], false)
  ...
  f.setNodeGraphVariable('28', [29, 30, 31], false)
  ...
  f.setNodeGraphVariable('117', [118, 119, 120], true)
  ...
  f.setNodeGraphVariable('175', [176, 177, 178], true)
  ...
  f.setNodeGraphVariable('233', [234, 235, 236], true)
  ...
  f.setNodeGraphVariable('291', [292, 293, 294], true)
  ...
  f.setNodeGraphVariable('349', [350, 351, 352], true)
  ...
  f.setNodeGraphVariable('407', [408, 409, 410], true)
  ...
  f.setNodeGraphVariable('465', [466, 467, 468], true)
