...
g.server({ id: 1073741933 }).on('whenEntityIsCreated', (_evt, f) => {
  ...
  f.assemblyDictionary([
    ...
    { k: new configId(3n), v: false }
  ])
  // assemblyDictionary :: dict<configId, configId>
  f.assemblyDictionary([
    { k: new configId(5n), v: new configId(6n) },
    { k: new configId(7n), v: new configId(8n) }
  ])
  // assemblyDictionary :: dict<configId, entity>
  f.assemblyDictionary([
    { k: new configId(9n), v: f.getSelfEntity() },
    { k: new configId(11n), v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<configId, faction>
  f.assemblyDictionary([
    { k: new configId(13n), v: new faction(14n) },
    { k: new configId(15n), v: new faction(16n) }
  ])
  // assemblyDictionary :: dict<configId, float>
  f.assemblyDictionary([
    { k: new configId(17n), v: 18.25 },
    { k: new configId(19n), v: 20.25 }
  ])
  // assemblyDictionary :: dict<configId, guid>
  f.assemblyDictionary([
    { k: new configId(21n), v: new guid(22n) },
    { k: new configId(23n), v: new guid(24n) }
  ])
  // assemblyDictionary :: dict<configId, int>
  f.assemblyDictionary([
    { k: new configId(25n), v: 26n },
    { k: new configId(27n), v: 28n }
  ])
  // assemblyDictionary :: dict<configId, list<bool>>
  f.assemblyDictionary([
    { k: new configId(29n), v: f.assemblyList([false, true, false], 'bool') },
    { k: new configId(31n), v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<configId, list<configId>>
  f.assemblyDictionary([
    { k: new configId(33n), v: f.assemblyList([34n, 35n, 36n], 'config_id') },
    { k: new configId(35n), v: f.assemblyList([36n, 37n, 38n], 'config_id') }
  ])
  // assemblyDictionary :: dict<configId, list<entity>>
  f.assemblyDictionary([
    {
      k: new configId(37n),
      v: f.assemblyList([f.getSelfEntity(), f.getSelfEntity(), f.getSelfEntity()], 'entity')
    },
    {
      k: new configId(40n),
      v: f.assemblyList([f.getSelfEntity(), f.getSelfEntity(), f.getSelfEntity()], 'entity')
  ...
  f.assemblyDictionary([
    { k: new configId(43n), v: f.assemblyList([44n, 45n, 46n], 'faction') },
    { k: new configId(45n), v: f.assemblyList([46n, 47n, 48n], 'faction') }
  ])
  // assemblyDictionary :: dict<configId, list<float>>
  f.assemblyDictionary([
    { k: new configId(47n), v: f.assemblyList([48.25, 49.25, 50.25], 'float') },
    { k: new configId(49n), v: f.assemblyList([50.25, 51.25, 52.25], 'float') }
  ])
  // assemblyDictionary :: dict<configId, list<guid>>
  f.assemblyDictionary([
    { k: new configId(51n), v: f.assemblyList([52n, 53n, 54n], 'guid') },
    { k: new configId(53n), v: f.assemblyList([54n, 55n, 56n], 'guid') }
  ])
  // assemblyDictionary :: dict<configId, list<int>>
  f.assemblyDictionary([
    { k: new configId(55n), v: f.assemblyList([56n, 57n, 58n], 'int') },
    { k: new configId(57n), v: f.assemblyList([58n, 59n, 60n], 'int') }
  ])
  // assemblyDictionary :: dict<configId, list<str>>
  f.assemblyDictionary([
    { k: new configId(59n), v: f.assemblyList(['60', '61', '62'], 'str') },
    { k: new configId(61n), v: f.assemblyList(['62', '63', '64'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: new configId(67n), v: new prefabId(68n) },
    { k: new configId(69n), v: new prefabId(70n) }
  ])
  // assemblyDictionary :: dict<configId, str>
  f.assemblyDictionary([
    { k: new configId(71n), v: '72' },
    { k: new configId(73n), v: '74' }
  ])
  // assemblyDictionary :: dict<configId, vec3>
  f.assemblyDictionary([
    { k: new configId(75n), v: [76, 77, 78] },
    { k: new configId(77n), v: [78, 79, 80] }
  ])
  // assemblyDictionary :: dict<entity, bool>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: false },
    { k: f.getSelfEntity(), v: false }
  ])
  // assemblyDictionary :: dict<entity, configId>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: new configId(84n) },
    { k: f.getSelfEntity(), v: new configId(86n) }
  ])
  // assemblyDictionary :: dict<entity, entity>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.getSelfEntity() },
    { k: f.getSelfEntity(), v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<entity, faction>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: new faction(92n) },
    { k: f.getSelfEntity(), v: new faction(94n) }
  ])
  // assemblyDictionary :: dict<entity, float>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: 96.25 },
    { k: f.getSelfEntity(), v: 98.25 }
  ])
  // assemblyDictionary :: dict<entity, guid>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: new guid(100n) },
    { k: f.getSelfEntity(), v: new guid(102n) }
  ])
  // assemblyDictionary :: dict<entity, int>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: 104n },
    { k: f.getSelfEntity(), v: 106n }
  ])
  // assemblyDictionary :: dict<entity, list<bool>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([false, true, false], 'bool') },
    { k: f.getSelfEntity(), v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<entity, list<configId>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([112n, 113n, 114n], 'config_id') },
    { k: f.getSelfEntity(), v: f.assemblyList([114n, 115n, 116n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([122n, 123n, 124n], 'faction') },
    { k: f.getSelfEntity(), v: f.assemblyList([124n, 125n, 126n], 'faction') }
  ])
  // assemblyDictionary :: dict<entity, list<float>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([126.25, 127.25, 128.25], 'float') },
    { k: f.getSelfEntity(), v: f.assemblyList([128.25, 129.25, 130.25], 'float') }
  ])
  // assemblyDictionary :: dict<entity, list<guid>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([130n, 131n, 132n], 'guid') },
    { k: f.getSelfEntity(), v: f.assemblyList([132n, 133n, 134n], 'guid') }
  ])
  // assemblyDictionary :: dict<entity, list<int>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList([134n, 135n, 136n], 'int') },
    { k: f.getSelfEntity(), v: f.assemblyList([136n, 137n, 138n], 'int') }
  ])
  // assemblyDictionary :: dict<entity, list<str>>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: f.assemblyList(['138', '139', '140'], 'str') },
    { k: f.getSelfEntity(), v: f.assemblyList(['140', '141', '142'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: new prefabId(146n) },
    { k: f.getSelfEntity(), v: new prefabId(148n) }
  ])
  // assemblyDictionary :: dict<entity, str>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: '150' },
    { k: f.getSelfEntity(), v: '152' }
  ])
  // assemblyDictionary :: dict<entity, vec3>
  f.assemblyDictionary([
    { k: f.getSelfEntity(), v: [154, 155, 156] },
    { k: f.getSelfEntity(), v: [156, 157, 158] }
  ])
  // assemblyDictionary :: dict<faction, bool>
  f.assemblyDictionary([
    { k: new faction(157n), v: false },
    { k: new faction(159n), v: false }
  ])
  // assemblyDictionary :: dict<faction, configId>
  f.assemblyDictionary([
    { k: new faction(161n), v: new configId(162n) },
    { k: new faction(163n), v: new configId(164n) }
  ])
  // assemblyDictionary :: dict<faction, entity>
  f.assemblyDictionary([
    { k: new faction(165n), v: f.getSelfEntity() },
    { k: new faction(167n), v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<faction, faction>
  f.assemblyDictionary([
    { k: new faction(169n), v: new faction(170n) },
    { k: new faction(171n), v: new faction(172n) }
  ])
  // assemblyDictionary :: dict<faction, float>
  f.assemblyDictionary([
    { k: new faction(173n), v: 174.25 },
    { k: new faction(175n), v: 176.25 }
  ])
  // assemblyDictionary :: dict<faction, guid>
  f.assemblyDictionary([
    { k: new faction(177n), v: new guid(178n) },
    { k: new faction(179n), v: new guid(180n) }
  ])
  // assemblyDictionary :: dict<faction, int>
  f.assemblyDictionary([
    { k: new faction(181n), v: 182n },
    { k: new faction(183n), v: 184n }
  ])
  // assemblyDictionary :: dict<faction, list<bool>>
  f.assemblyDictionary([
    { k: new faction(185n), v: f.assemblyList([false, true, false], 'bool') },
    { k: new faction(187n), v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<faction, list<configId>>
  f.assemblyDictionary([
    { k: new faction(189n), v: f.assemblyList([190n, 191n, 192n], 'config_id') },
    { k: new faction(191n), v: f.assemblyList([192n, 193n, 194n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: new faction(199n), v: f.assemblyList([200n, 201n, 202n], 'faction') },
    { k: new faction(201n), v: f.assemblyList([202n, 203n, 204n], 'faction') }
  ])
  // assemblyDictionary :: dict<faction, list<float>>
  f.assemblyDictionary([
    { k: new faction(203n), v: f.assemblyList([204.25, 205.25, 206.25], 'float') },
    { k: new faction(205n), v: f.assemblyList([206.25, 207.25, 208.25], 'float') }
  ])
  // assemblyDictionary :: dict<faction, list<guid>>
  f.assemblyDictionary([
    { k: new faction(207n), v: f.assemblyList([208n, 209n, 210n], 'guid') },
    { k: new faction(209n), v: f.assemblyList([210n, 211n, 212n], 'guid') }
  ])
  // assemblyDictionary :: dict<faction, list<int>>
  f.assemblyDictionary([
    { k: new faction(211n), v: f.assemblyList([212n, 213n, 214n], 'int') },
    { k: new faction(213n), v: f.assemblyList([214n, 215n, 216n], 'int') }
  ])
  // assemblyDictionary :: dict<faction, list<str>>
  f.assemblyDictionary([
    { k: new faction(215n), v: f.assemblyList(['216', '217', '218'], 'str') },
    { k: new faction(217n), v: f.assemblyList(['218', '219', '220'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: new faction(223n), v: new prefabId(224n) },
    { k: new faction(225n), v: new prefabId(226n) }
  ])
  // assemblyDictionary :: dict<faction, str>
  f.assemblyDictionary([
    { k: new faction(227n), v: '228' },
    { k: new faction(229n), v: '230' }
  ])
  // assemblyDictionary :: dict<faction, vec3>
  f.assemblyDictionary([
    { k: new faction(231n), v: [232, 233, 234] },
    { k: new faction(233n), v: [234, 235, 236] }
  ])
  // assemblyDictionary :: dict<guid, bool>
  f.assemblyDictionary([
    { k: new guid(235n), v: false },
    { k: new guid(237n), v: false }
  ])
  // assemblyDictionary :: dict<guid, configId>
  f.assemblyDictionary([
    { k: new guid(239n), v: new configId(240n) },
    { k: new guid(241n), v: new configId(242n) }
  ])
  // assemblyDictionary :: dict<guid, entity>
  f.assemblyDictionary([
    { k: new guid(243n), v: f.getSelfEntity() },
    { k: new guid(245n), v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<guid, faction>
  f.assemblyDictionary([
    { k: new guid(247n), v: new faction(248n) },
    { k: new guid(249n), v: new faction(250n) }
  ])
  // assemblyDictionary :: dict<guid, float>
  f.assemblyDictionary([
    { k: new guid(251n), v: 252.25 },
    { k: new guid(253n), v: 254.25 }
  ])
  // assemblyDictionary :: dict<guid, guid>
  f.assemblyDictionary([
    { k: new guid(255n), v: new guid(256n) },
    { k: new guid(257n), v: new guid(258n) }
  ])
  // assemblyDictionary :: dict<guid, int>
  f.assemblyDictionary([
    { k: new guid(259n), v: 260n },
    { k: new guid(261n), v: 262n }
  ])
  // assemblyDictionary :: dict<guid, list<bool>>
  f.assemblyDictionary([
    { k: new guid(263n), v: f.assemblyList([false, true, false], 'bool') },
    { k: new guid(265n), v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<guid, list<configId>>
  f.assemblyDictionary([
    { k: new guid(267n), v: f.assemblyList([268n, 269n, 270n], 'config_id') },
    { k: new guid(269n), v: f.assemblyList([270n, 271n, 272n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: new guid(277n), v: f.assemblyList([278n, 279n, 280n], 'faction') },
    { k: new guid(279n), v: f.assemblyList([280n, 281n, 282n], 'faction') }
  ])
  // assemblyDictionary :: dict<guid, list<float>>
  f.assemblyDictionary([
    { k: new guid(281n), v: f.assemblyList([282.25, 283.25, 284.25], 'float') },
    { k: new guid(283n), v: f.assemblyList([284.25, 285.25, 286.25], 'float') }
  ])
  // assemblyDictionary :: dict<guid, list<guid>>
  f.assemblyDictionary([
    { k: new guid(285n), v: f.assemblyList([286n, 287n, 288n], 'guid') },
    { k: new guid(287n), v: f.assemblyList([288n, 289n, 290n], 'guid') }
  ])
  // assemblyDictionary :: dict<guid, list<int>>
  f.assemblyDictionary([
    { k: new guid(289n), v: f.assemblyList([290n, 291n, 292n], 'int') },
    { k: new guid(291n), v: f.assemblyList([292n, 293n, 294n], 'int') }
  ])
  // assemblyDictionary :: dict<guid, list<str>>
  f.assemblyDictionary([
    { k: new guid(293n), v: f.assemblyList(['294', '295', '296'], 'str') },
    { k: new guid(295n), v: f.assemblyList(['296', '297', '298'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: new guid(301n), v: new prefabId(302n) },
    { k: new guid(303n), v: new prefabId(304n) }
  ])
  // assemblyDictionary :: dict<guid, str>
  f.assemblyDictionary([
    { k: new guid(305n), v: '306' },
    { k: new guid(307n), v: '308' }
  ])
  // assemblyDictionary :: dict<guid, vec3>
  f.assemblyDictionary([
    { k: new guid(309n), v: [310, 311, 312] },
    { k: new guid(311n), v: [312, 313, 314] }
  ])
  ...
  f.assemblyDictionary([
    { k: 317n, v: new configId(318n) },
    { k: 319n, v: new configId(320n) }
  ])
  // assemblyDictionary :: dict<int, entity>
  f.assemblyDictionary([
    { k: 321n, v: f.getSelfEntity() },
    { k: 323n, v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<int, faction>
  f.assemblyDictionary([
    { k: 325n, v: new faction(326n) },
    { k: 327n, v: new faction(328n) }
  ])
  ...
  f.assemblyDictionary([
    { k: 333n, v: new guid(334n) },
    { k: 335n, v: new guid(336n) }
  ])
  ...
  f.assemblyDictionary([
    { k: 341n, v: f.assemblyList([false, true, false], 'bool') },
    { k: 343n, v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<int, list<configId>>
  f.assemblyDictionary([
    { k: 345n, v: f.assemblyList([346n, 347n, 348n], 'config_id') },
    { k: 347n, v: f.assemblyList([348n, 349n, 350n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: 355n, v: f.assemblyList([356n, 357n, 358n], 'faction') },
    { k: 357n, v: f.assemblyList([358n, 359n, 360n], 'faction') }
  ])
  // assemblyDictionary :: dict<int, list<float>>
  f.assemblyDictionary([
    { k: 359n, v: f.assemblyList([360.25, 361.25, 362.25], 'float') },
    { k: 361n, v: f.assemblyList([362.25, 363.25, 364.25], 'float') }
  ])
  // assemblyDictionary :: dict<int, list<guid>>
  f.assemblyDictionary([
    { k: 363n, v: f.assemblyList([364n, 365n, 366n], 'guid') },
    { k: 365n, v: f.assemblyList([366n, 367n, 368n], 'guid') }
  ])
  // assemblyDictionary :: dict<int, list<int>>
  f.assemblyDictionary([
    { k: 367n, v: f.assemblyList([368n, 369n, 370n], 'int') },
    { k: 369n, v: f.assemblyList([370n, 371n, 372n], 'int') }
  ])
  // assemblyDictionary :: dict<int, list<str>>
  f.assemblyDictionary([
    { k: 371n, v: f.assemblyList(['372', '373', '374'], 'str') },
    { k: 373n, v: f.assemblyList(['374', '375', '376'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: 379n, v: new prefabId(380n) },
    { k: 381n, v: new prefabId(382n) }
  ])
  ...
  f.assemblyDictionary([
    { k: 387n, v: [388, 389, 390] },
    { k: 389n, v: [390, 391, 392] }
  ])
  // assemblyDictionary :: dict<prefabId, bool>
  f.assemblyDictionary([
    { k: new prefabId(391n), v: false },
    { k: new prefabId(393n), v: false }
  ])
  // assemblyDictionary :: dict<prefabId, configId>
  f.assemblyDictionary([
    { k: new prefabId(395n), v: new configId(396n) },
    { k: new prefabId(397n), v: new configId(398n) }
  ])
  // assemblyDictionary :: dict<prefabId, entity>
  f.assemblyDictionary([
    { k: new prefabId(399n), v: f.getSelfEntity() },
    { k: new prefabId(401n), v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<prefabId, faction>
  f.assemblyDictionary([
    { k: new prefabId(403n), v: new faction(404n) },
    { k: new prefabId(405n), v: new faction(406n) }
  ])
  // assemblyDictionary :: dict<prefabId, float>
  f.assemblyDictionary([
    { k: new prefabId(407n), v: 408.25 },
    { k: new prefabId(409n), v: 410.25 }
  ])
  // assemblyDictionary :: dict<prefabId, guid>
  f.assemblyDictionary([
    { k: new prefabId(411n), v: new guid(412n) },
    { k: new prefabId(413n), v: new guid(414n) }
  ])
  // assemblyDictionary :: dict<prefabId, int>
  f.assemblyDictionary([
    { k: new prefabId(415n), v: 416n },
    { k: new prefabId(417n), v: 418n }
  ])
  // assemblyDictionary :: dict<prefabId, list<bool>>
  f.assemblyDictionary([
    { k: new prefabId(419n), v: f.assemblyList([false, true, false], 'bool') },
    { k: new prefabId(421n), v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<prefabId, list<configId>>
  f.assemblyDictionary([
    { k: new prefabId(423n), v: f.assemblyList([424n, 425n, 426n], 'config_id') },
    { k: new prefabId(425n), v: f.assemblyList([426n, 427n, 428n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: new prefabId(433n), v: f.assemblyList([434n, 435n, 436n], 'faction') },
    { k: new prefabId(435n), v: f.assemblyList([436n, 437n, 438n], 'faction') }
  ])
  // assemblyDictionary :: dict<prefabId, list<float>>
  f.assemblyDictionary([
    { k: new prefabId(437n), v: f.assemblyList([438.25, 439.25, 440.25], 'float') },
    { k: new prefabId(439n), v: f.assemblyList([440.25, 441.25, 442.25], 'float') }
  ])
  // assemblyDictionary :: dict<prefabId, list<guid>>
  f.assemblyDictionary([
    { k: new prefabId(441n), v: f.assemblyList([442n, 443n, 444n], 'guid') },
    { k: new prefabId(443n), v: f.assemblyList([444n, 445n, 446n], 'guid') }
  ])
  // assemblyDictionary :: dict<prefabId, list<int>>
  f.assemblyDictionary([
    { k: new prefabId(445n), v: f.assemblyList([446n, 447n, 448n], 'int') },
    { k: new prefabId(447n), v: f.assemblyList([448n, 449n, 450n], 'int') }
  ])
  // assemblyDictionary :: dict<prefabId, list<str>>
  f.assemblyDictionary([
    { k: new prefabId(449n), v: f.assemblyList(['450', '451', '452'], 'str') },
    { k: new prefabId(451n), v: f.assemblyList(['452', '453', '454'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: new prefabId(457n), v: new prefabId(458n) },
    { k: new prefabId(459n), v: new prefabId(460n) }
  ])
  // assemblyDictionary :: dict<prefabId, str>
  f.assemblyDictionary([
    { k: new prefabId(461n), v: '462' },
    { k: new prefabId(463n), v: '464' }
  ])
  // assemblyDictionary :: dict<prefabId, vec3>
  f.assemblyDictionary([
    { k: new prefabId(465n), v: [466, 467, 468] },
    { k: new prefabId(467n), v: [468, 469, 470] }
  ])
  ...
  f.assemblyDictionary([
    { k: '473', v: new configId(474n) },
    { k: '475', v: new configId(476n) }
  ])
  // assemblyDictionary :: dict<str, entity>
  f.assemblyDictionary([
    { k: '477', v: f.getSelfEntity() },
    { k: '479', v: f.getSelfEntity() }
  ])
  // assemblyDictionary :: dict<str, faction>
  f.assemblyDictionary([
    { k: '481', v: new faction(482n) },
    { k: '483', v: new faction(484n) }
  ])
  ...
  f.assemblyDictionary([
    { k: '489', v: new guid(490n) },
    { k: '491', v: new guid(492n) }
  ])
  ...
  f.assemblyDictionary([
    { k: '497', v: f.assemblyList([false, true, false], 'bool') },
    { k: '499', v: f.assemblyList([false, true, false], 'bool') }
  ])
  // assemblyDictionary :: dict<str, list<configId>>
  f.assemblyDictionary([
    { k: '501', v: f.assemblyList([502n, 503n, 504n], 'config_id') },
    { k: '503', v: f.assemblyList([504n, 505n, 506n], 'config_id') }
  ])
  ...
  f.assemblyDictionary([
    { k: '511', v: f.assemblyList([512n, 513n, 514n], 'faction') },
    { k: '513', v: f.assemblyList([514n, 515n, 516n], 'faction') }
  ])
  // assemblyDictionary :: dict<str, list<float>>
  f.assemblyDictionary([
    { k: '515', v: f.assemblyList([516.25, 517.25, 518.25], 'float') },
    { k: '517', v: f.assemblyList([518.25, 519.25, 520.25], 'float') }
  ])
  // assemblyDictionary :: dict<str, list<guid>>
  f.assemblyDictionary([
    { k: '519', v: f.assemblyList([520n, 521n, 522n], 'guid') },
    { k: '521', v: f.assemblyList([522n, 523n, 524n], 'guid') }
  ])
  // assemblyDictionary :: dict<str, list<int>>
  f.assemblyDictionary([
    { k: '523', v: f.assemblyList([524n, 525n, 526n], 'int') },
    { k: '525', v: f.assemblyList([526n, 527n, 528n], 'int') }
  ])
  // assemblyDictionary :: dict<str, list<str>>
  f.assemblyDictionary([
    { k: '527', v: f.assemblyList(['528', '529', '530'], 'str') },
    { k: '529', v: f.assemblyList(['530', '531', '532'], 'str') }
  ])
  ...
  f.assemblyDictionary([
    { k: '535', v: new prefabId(536n) },
    { k: '537', v: new prefabId(538n) }
  ])
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(2n), v: true },
      { k: new configId(4n), v: true }
    ]),
    new configId(6n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(8n), v: new configId(9n) },
      { k: new configId(10n), v: new configId(11n) }
    ]),
    new configId(12n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(14n), v: f.getSelfEntity() },
      { k: new configId(16n), v: f.getSelfEntity() }
    ]),
    new configId(18n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(20n), v: new faction(21n) },
      { k: new configId(22n), v: new faction(23n) }
    ]),
    new configId(24n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(26n), v: 27.25 },
      { k: new configId(28n), v: 29.25 }
    ]),
    new configId(30n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(32n), v: new guid(33n) },
      { k: new configId(34n), v: new guid(35n) }
    ]),
    new configId(36n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(38n), v: 39n },
      { k: new configId(40n), v: 41n }
    ]),
    new configId(42n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(44n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new configId(46n), v: f.assemblyList([true, false, true], 'bool') }
    ]),
    new configId(48n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(50n), v: f.assemblyList([51n, 52n, 53n], 'config_id') },
      { k: new configId(52n), v: f.assemblyList([53n, 54n, 55n], 'config_id') }
    ]),
    new configId(54n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(64n), v: f.assemblyList([65n, 66n, 67n], 'faction') },
      { k: new configId(66n), v: f.assemblyList([67n, 68n, 69n], 'faction') }
    ]),
    new configId(68n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(70n), v: f.assemblyList([71.25, 72.25, 73.25], 'float') },
      { k: new configId(72n), v: f.assemblyList([73.25, 74.25, 75.25], 'float') }
    ]),
    new configId(74n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(76n), v: f.assemblyList([77n, 78n, 79n], 'guid') },
      { k: new configId(78n), v: f.assemblyList([79n, 80n, 81n], 'guid') }
    ]),
    new configId(80n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(82n), v: f.assemblyList([83n, 84n, 85n], 'int') },
      { k: new configId(84n), v: f.assemblyList([85n, 86n, 87n], 'int') }
    ]),
    new configId(86n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(88n), v: f.assemblyList(['89', '90', '91'], 'str') },
      { k: new configId(90n), v: f.assemblyList(['91', '92', '93'], 'str') }
    ]),
    new configId(92n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(100n), v: new prefabId(101n) },
      { k: new configId(102n), v: new prefabId(103n) }
    ]),
    new configId(104n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(106n), v: '107' },
      { k: new configId(108n), v: '109' }
    ]),
    new configId(110n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new configId(112n), v: [113, 114, 115] },
      { k: new configId(114n), v: [115, 116, 117] }
    ]),
    new configId(116n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new configId(125n) },
      { k: f.getSelfEntity(), v: new configId(127n) }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new faction(137n) },
      { k: f.getSelfEntity(), v: new faction(139n) }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 143.25 },
      { k: f.getSelfEntity(), v: 145.25 }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new guid(149n) },
      { k: f.getSelfEntity(), v: new guid(151n) }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 155n },
      { k: f.getSelfEntity(), v: 157n }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([true, false, true], 'bool') },
      { k: f.getSelfEntity(), v: f.assemblyList([true, false, true], 'bool') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([167n, 168n, 169n], 'config_id') },
      { k: f.getSelfEntity(), v: f.assemblyList([169n, 170n, 171n], 'config_id') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([181n, 182n, 183n], 'faction') },
      { k: f.getSelfEntity(), v: f.assemblyList([183n, 184n, 185n], 'faction') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([187.25, 188.25, 189.25], 'float') },
      { k: f.getSelfEntity(), v: f.assemblyList([189.25, 190.25, 191.25], 'float') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([193n, 194n, 195n], 'guid') },
      { k: f.getSelfEntity(), v: f.assemblyList([195n, 196n, 197n], 'guid') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([199n, 200n, 201n], 'int') },
      { k: f.getSelfEntity(), v: f.assemblyList([201n, 202n, 203n], 'int') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList(['205', '206', '207'], 'str') },
      { k: f.getSelfEntity(), v: f.assemblyList(['207', '208', '209'], 'str') }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new prefabId(217n) },
      { k: f.getSelfEntity(), v: new prefabId(219n) }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: '223' },
      { k: f.getSelfEntity(), v: '225' }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: [229, 230, 231] },
      { k: f.getSelfEntity(), v: [231, 232, 233] }
    ]),
    f.getSelfEntity()
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(234n), v: true },
      { k: new faction(236n), v: true }
    ]),
    new faction(238n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(240n), v: new configId(241n) },
      { k: new faction(242n), v: new configId(243n) }
    ]),
    new faction(244n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(246n), v: f.getSelfEntity() },
      { k: new faction(248n), v: f.getSelfEntity() }
    ]),
    new faction(250n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(252n), v: new faction(253n) },
      { k: new faction(254n), v: new faction(255n) }
    ]),
    new faction(256n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(258n), v: 259.25 },
      { k: new faction(260n), v: 261.25 }
    ]),
    new faction(262n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(264n), v: new guid(265n) },
      { k: new faction(266n), v: new guid(267n) }
    ]),
    new faction(268n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(270n), v: 271n },
      { k: new faction(272n), v: 273n }
    ]),
    new faction(274n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(276n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new faction(278n), v: f.assemblyList([true, false, true], 'bool') }
    ]),
    new faction(280n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(282n), v: f.assemblyList([283n, 284n, 285n], 'config_id') },
      { k: new faction(284n), v: f.assemblyList([285n, 286n, 287n], 'config_id') }
    ]),
    new faction(286n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(296n), v: f.assemblyList([297n, 298n, 299n], 'faction') },
      { k: new faction(298n), v: f.assemblyList([299n, 300n, 301n], 'faction') }
    ]),
    new faction(300n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(302n), v: f.assemblyList([303.25, 304.25, 305.25], 'float') },
      { k: new faction(304n), v: f.assemblyList([305.25, 306.25, 307.25], 'float') }
    ]),
    new faction(306n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(308n), v: f.assemblyList([309n, 310n, 311n], 'guid') },
      { k: new faction(310n), v: f.assemblyList([311n, 312n, 313n], 'guid') }
    ]),
    new faction(312n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(314n), v: f.assemblyList([315n, 316n, 317n], 'int') },
      { k: new faction(316n), v: f.assemblyList([317n, 318n, 319n], 'int') }
    ]),
    new faction(318n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(320n), v: f.assemblyList(['321', '322', '323'], 'str') },
      { k: new faction(322n), v: f.assemblyList(['323', '324', '325'], 'str') }
    ]),
    new faction(324n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(332n), v: new prefabId(333n) },
      { k: new faction(334n), v: new prefabId(335n) }
    ]),
    new faction(336n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(338n), v: '339' },
      { k: new faction(340n), v: '341' }
    ]),
    new faction(342n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new faction(344n), v: [345, 346, 347] },
      { k: new faction(346n), v: [347, 348, 349] }
    ]),
    new faction(348n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(350n), v: true },
      { k: new guid(352n), v: true }
    ]),
    new guid(354n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(356n), v: new configId(357n) },
      { k: new guid(358n), v: new configId(359n) }
    ]),
    new guid(360n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(362n), v: f.getSelfEntity() },
      { k: new guid(364n), v: f.getSelfEntity() }
    ]),
    new guid(366n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(368n), v: new faction(369n) },
      { k: new guid(370n), v: new faction(371n) }
    ]),
    new guid(372n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(374n), v: 375.25 },
      { k: new guid(376n), v: 377.25 }
    ]),
    new guid(378n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(380n), v: new guid(381n) },
      { k: new guid(382n), v: new guid(383n) }
    ]),
    new guid(384n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(386n), v: 387n },
      { k: new guid(388n), v: 389n }
    ]),
    new guid(390n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(392n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new guid(394n), v: f.assemblyList([true, false, true], 'bool') }
    ]),
    new guid(396n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(398n), v: f.assemblyList([399n, 400n, 401n], 'config_id') },
      { k: new guid(400n), v: f.assemblyList([401n, 402n, 403n], 'config_id') }
    ]),
    new guid(402n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(412n), v: f.assemblyList([413n, 414n, 415n], 'faction') },
      { k: new guid(414n), v: f.assemblyList([415n, 416n, 417n], 'faction') }
    ]),
    new guid(416n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(418n), v: f.assemblyList([419.25, 420.25, 421.25], 'float') },
      { k: new guid(420n), v: f.assemblyList([421.25, 422.25, 423.25], 'float') }
    ]),
    new guid(422n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(424n), v: f.assemblyList([425n, 426n, 427n], 'guid') },
      { k: new guid(426n), v: f.assemblyList([427n, 428n, 429n], 'guid') }
    ]),
    new guid(428n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(430n), v: f.assemblyList([431n, 432n, 433n], 'int') },
      { k: new guid(432n), v: f.assemblyList([433n, 434n, 435n], 'int') }
    ]),
    new guid(434n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(436n), v: f.assemblyList(['437', '438', '439'], 'str') },
      { k: new guid(438n), v: f.assemblyList(['439', '440', '441'], 'str') }
    ]),
    new guid(440n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(448n), v: new prefabId(449n) },
      { k: new guid(450n), v: new prefabId(451n) }
    ]),
    new guid(452n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(454n), v: '455' },
      { k: new guid(456n), v: '457' }
    ]),
    new guid(458n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new guid(460n), v: [461, 462, 463] },
      { k: new guid(462n), v: [463, 464, 465] }
    ]),
    new guid(464n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 472n, v: new configId(473n) },
      { k: 474n, v: new configId(475n) }
    ]),
    476n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 478n, v: f.getSelfEntity() },
      { k: 480n, v: f.getSelfEntity() }
    ]),
    482n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 484n, v: new faction(485n) },
      { k: 486n, v: new faction(487n) }
    ]),
    488n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 496n, v: new guid(497n) },
      { k: 498n, v: new guid(499n) }
    ]),
    500n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 508n, v: f.assemblyList([true, false, true], 'bool') },
      { k: 510n, v: f.assemblyList([true, false, true], 'bool') }
    ]),
    512n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 514n, v: f.assemblyList([515n, 516n, 517n], 'config_id') },
      { k: 516n, v: f.assemblyList([517n, 518n, 519n], 'config_id') }
    ]),
    518n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 528n, v: f.assemblyList([529n, 530n, 531n], 'faction') },
      { k: 530n, v: f.assemblyList([531n, 532n, 533n], 'faction') }
    ]),
    532n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 534n, v: f.assemblyList([535.25, 536.25, 537.25], 'float') },
      { k: 536n, v: f.assemblyList([537.25, 538.25, 539.25], 'float') }
    ]),
    538n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 540n, v: f.assemblyList([541n, 542n, 543n], 'guid') },
      { k: 542n, v: f.assemblyList([543n, 544n, 545n], 'guid') }
    ]),
    544n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 546n, v: f.assemblyList([547n, 548n, 549n], 'int') },
      { k: 548n, v: f.assemblyList([549n, 550n, 551n], 'int') }
    ]),
    550n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 552n, v: f.assemblyList(['553', '554', '555'], 'str') },
      { k: 554n, v: f.assemblyList(['555', '556', '557'], 'str') }
    ]),
    556n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 564n, v: new prefabId(565n) },
      { k: 566n, v: new prefabId(567n) }
    ]),
    568n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: 576n, v: [577, 578, 579] },
      { k: 578n, v: [579, 580, 581] }
    ]),
    580n
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(582n), v: true },
      { k: new prefabId(584n), v: true }
    ]),
    new prefabId(586n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(588n), v: new configId(589n) },
      { k: new prefabId(590n), v: new configId(591n) }
    ]),
    new prefabId(592n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(594n), v: f.getSelfEntity() },
      { k: new prefabId(596n), v: f.getSelfEntity() }
    ]),
    new prefabId(598n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(600n), v: new faction(601n) },
      { k: new prefabId(602n), v: new faction(603n) }
    ]),
    new prefabId(604n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(606n), v: 607.25 },
      { k: new prefabId(608n), v: 609.25 }
    ]),
    new prefabId(610n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(612n), v: new guid(613n) },
      { k: new prefabId(614n), v: new guid(615n) }
    ]),
    new prefabId(616n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(618n), v: 619n },
      { k: new prefabId(620n), v: 621n }
    ]),
    new prefabId(622n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(624n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new prefabId(626n), v: f.assemblyList([true, false, true], 'bool') }
    ]),
    new prefabId(628n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(630n), v: f.assemblyList([631n, 632n, 633n], 'config_id') },
      { k: new prefabId(632n), v: f.assemblyList([633n, 634n, 635n], 'config_id') }
    ]),
    new prefabId(634n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(644n), v: f.assemblyList([645n, 646n, 647n], 'faction') },
      { k: new prefabId(646n), v: f.assemblyList([647n, 648n, 649n], 'faction') }
    ]),
    new prefabId(648n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(650n), v: f.assemblyList([651.25, 652.25, 653.25], 'float') },
      { k: new prefabId(652n), v: f.assemblyList([653.25, 654.25, 655.25], 'float') }
    ]),
    new prefabId(654n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(656n), v: f.assemblyList([657n, 658n, 659n], 'guid') },
      { k: new prefabId(658n), v: f.assemblyList([659n, 660n, 661n], 'guid') }
    ]),
    new prefabId(660n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(662n), v: f.assemblyList([663n, 664n, 665n], 'int') },
      { k: new prefabId(664n), v: f.assemblyList([665n, 666n, 667n], 'int') }
    ]),
    new prefabId(666n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(668n), v: f.assemblyList(['669', '670', '671'], 'str') },
      { k: new prefabId(670n), v: f.assemblyList(['671', '672', '673'], 'str') }
    ]),
    new prefabId(672n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(680n), v: new prefabId(681n) },
      { k: new prefabId(682n), v: new prefabId(683n) }
    ]),
    new prefabId(684n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(686n), v: '687' },
      { k: new prefabId(688n), v: '689' }
    ]),
    new prefabId(690n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: new prefabId(692n), v: [693, 694, 695] },
      { k: new prefabId(694n), v: [695, 696, 697] }
    ]),
    new prefabId(696n)
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '704', v: new configId(705n) },
      { k: '706', v: new configId(707n) }
    ]),
    '708'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '710', v: f.getSelfEntity() },
      { k: '712', v: f.getSelfEntity() }
    ]),
    '714'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '716', v: new faction(717n) },
      { k: '718', v: new faction(719n) }
    ]),
    '720'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '728', v: new guid(729n) },
      { k: '730', v: new guid(731n) }
    ]),
    '732'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '740', v: f.assemblyList([true, false, true], 'bool') },
      { k: '742', v: f.assemblyList([true, false, true], 'bool') }
    ]),
    '744'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '746', v: f.assemblyList([747n, 748n, 749n], 'config_id') },
      { k: '748', v: f.assemblyList([749n, 750n, 751n], 'config_id') }
    ]),
    '750'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '760', v: f.assemblyList([761n, 762n, 763n], 'faction') },
      { k: '762', v: f.assemblyList([763n, 764n, 765n], 'faction') }
    ]),
    '764'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '766', v: f.assemblyList([767.25, 768.25, 769.25], 'float') },
      { k: '768', v: f.assemblyList([769.25, 770.25, 771.25], 'float') }
    ]),
    '770'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '772', v: f.assemblyList([773n, 774n, 775n], 'guid') },
      { k: '774', v: f.assemblyList([775n, 776n, 777n], 'guid') }
    ]),
    '776'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '778', v: f.assemblyList([779n, 780n, 781n], 'int') },
      { k: '780', v: f.assemblyList([781n, 782n, 783n], 'int') }
    ]),
    '782'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '784', v: f.assemblyList(['785', '786', '787'], 'str') },
      { k: '786', v: f.assemblyList(['787', '788', '789'], 'str') }
    ]),
    '788'
  )
  ...
  f.queryDictionaryValueByKey(
    f.assemblyDictionary([
      { k: '796', v: new prefabId(797n) },
      { k: '798', v: new prefabId(799n) }
    ]),
    '800'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(9n), v: new configId(10n) },
      { k: new configId(11n), v: new configId(12n) }
    ]),
    new configId(13n),
    new configId(14n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(16n), v: f.getSelfEntity() },
      { k: new configId(18n), v: f.getSelfEntity() }
    ]),
    new configId(20n),
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(23n), v: new faction(24n) },
      { k: new configId(25n), v: new faction(26n) }
    ]),
    new configId(27n),
    new faction(28n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(30n), v: 31.25 },
      { k: new configId(32n), v: 33.25 }
    ]),
    new configId(34n),
    35.25
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(37n), v: new guid(38n) },
      { k: new configId(39n), v: new guid(40n) }
    ]),
    new configId(41n),
    new guid(42n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(44n), v: 45n },
      { k: new configId(46n), v: 47n }
    ]),
    new configId(48n),
    49n
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(51n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new configId(53n), v: f.assemblyList([false, true, false], 'bool') }
    ]),
    new configId(55n),
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(58n), v: f.assemblyList([59n, 60n, 61n], 'config_id') },
      { k: new configId(60n), v: f.assemblyList([61n, 62n, 63n], 'config_id') }
    ]),
    new configId(62n),
    f.assemblyList([63n, 64n, 65n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(75n), v: f.assemblyList([76n, 77n, 78n], 'faction') },
      { k: new configId(77n), v: f.assemblyList([78n, 79n, 80n], 'faction') }
    ]),
    new configId(79n),
    f.assemblyList([80n, 81n, 82n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<configId, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(82n), v: f.assemblyList([83.25, 84.25, 85.25], 'float') },
      { k: new configId(84n), v: f.assemblyList([85.25, 86.25, 87.25], 'float') }
    ]),
    new configId(86n),
    f.assemblyList([87.25, 88.25, 89.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<configId, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(89n), v: f.assemblyList([90n, 91n, 92n], 'guid') },
      { k: new configId(91n), v: f.assemblyList([92n, 93n, 94n], 'guid') }
    ]),
    new configId(93n),
    f.assemblyList([94n, 95n, 96n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<configId, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(96n), v: f.assemblyList([97n, 98n, 99n], 'int') },
      { k: new configId(98n), v: f.assemblyList([99n, 100n, 101n], 'int') }
    ]),
    new configId(100n),
    f.assemblyList([101n, 102n, 103n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<configId, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(103n), v: f.assemblyList(['104', '105', '106'], 'str') },
      { k: new configId(105n), v: f.assemblyList(['106', '107', '108'], 'str') }
    ]),
    new configId(107n),
    f.assemblyList(['108', '109', '110'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(117n), v: new prefabId(118n) },
      { k: new configId(119n), v: new prefabId(120n) }
    ]),
    new configId(121n),
    new prefabId(122n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(124n), v: '125' },
      { k: new configId(126n), v: '127' }
    ]),
    new configId(128n),
    '129'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new configId(131n), v: [132, 133, 134] },
      { k: new configId(133n), v: [134, 135, 136] }
    ]),
    new configId(135n),
    [136, 137, 138]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new configId(146n) },
      { k: f.getSelfEntity(), v: new configId(148n) }
    ]),
    f.getSelfEntity(),
    new configId(150n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new faction(160n) },
      { k: f.getSelfEntity(), v: new faction(162n) }
    ]),
    f.getSelfEntity(),
    new faction(164n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 167.25 },
      { k: f.getSelfEntity(), v: 169.25 }
    ]),
    f.getSelfEntity(),
    171.25
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new guid(174n) },
      { k: f.getSelfEntity(), v: new guid(176n) }
    ]),
    f.getSelfEntity(),
    new guid(178n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 181n },
      { k: f.getSelfEntity(), v: 183n }
    ]),
    f.getSelfEntity(),
    185n
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([195n, 196n, 197n], 'config_id') },
      { k: f.getSelfEntity(), v: f.assemblyList([197n, 198n, 199n], 'config_id') }
    ]),
    f.getSelfEntity(),
    f.assemblyList([199n, 200n, 201n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([212n, 213n, 214n], 'faction') },
      { k: f.getSelfEntity(), v: f.assemblyList([214n, 215n, 216n], 'faction') }
    ]),
    f.getSelfEntity(),
    f.assemblyList([216n, 217n, 218n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<entity, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([219.25, 220.25, 221.25], 'float') },
      { k: f.getSelfEntity(), v: f.assemblyList([221.25, 222.25, 223.25], 'float') }
    ]),
    f.getSelfEntity(),
    f.assemblyList([223.25, 224.25, 225.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<entity, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([226n, 227n, 228n], 'guid') },
      { k: f.getSelfEntity(), v: f.assemblyList([228n, 229n, 230n], 'guid') }
    ]),
    f.getSelfEntity(),
    f.assemblyList([230n, 231n, 232n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<entity, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([233n, 234n, 235n], 'int') },
      { k: f.getSelfEntity(), v: f.assemblyList([235n, 236n, 237n], 'int') }
    ]),
    f.getSelfEntity(),
    f.assemblyList([237n, 238n, 239n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<entity, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList(['240', '241', '242'], 'str') },
      { k: f.getSelfEntity(), v: f.assemblyList(['242', '243', '244'], 'str') }
    ]),
    f.getSelfEntity(),
    f.assemblyList(['244', '245', '246'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new prefabId(254n) },
      { k: f.getSelfEntity(), v: new prefabId(256n) }
    ]),
    f.getSelfEntity(),
    new prefabId(258n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: '261' },
      { k: f.getSelfEntity(), v: '263' }
    ]),
    f.getSelfEntity(),
    '265'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: [268, 269, 270] },
      { k: f.getSelfEntity(), v: [270, 271, 272] }
    ]),
    f.getSelfEntity(),
    [272, 273, 274]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(274n), v: true },
      { k: new faction(276n), v: true }
    ]),
    new faction(278n),
    true
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(281n), v: new configId(282n) },
      { k: new faction(283n), v: new configId(284n) }
    ]),
    new faction(285n),
    new configId(286n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(288n), v: f.getSelfEntity() },
      { k: new faction(290n), v: f.getSelfEntity() }
    ]),
    new faction(292n),
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(295n), v: new faction(296n) },
      { k: new faction(297n), v: new faction(298n) }
    ]),
    new faction(299n),
    new faction(300n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(302n), v: 303.25 },
      { k: new faction(304n), v: 305.25 }
    ]),
    new faction(306n),
    307.25
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(309n), v: new guid(310n) },
      { k: new faction(311n), v: new guid(312n) }
    ]),
    new faction(313n),
    new guid(314n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(316n), v: 317n },
      { k: new faction(318n), v: 319n }
    ]),
    new faction(320n),
    321n
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(323n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new faction(325n), v: f.assemblyList([false, true, false], 'bool') }
    ]),
    new faction(327n),
    f.assemblyList([false, true, false], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(330n), v: f.assemblyList([331n, 332n, 333n], 'config_id') },
      { k: new faction(332n), v: f.assemblyList([333n, 334n, 335n], 'config_id') }
    ]),
    new faction(334n),
    f.assemblyList([335n, 336n, 337n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(347n), v: f.assemblyList([348n, 349n, 350n], 'faction') },
      { k: new faction(349n), v: f.assemblyList([350n, 351n, 352n], 'faction') }
    ]),
    new faction(351n),
    f.assemblyList([352n, 353n, 354n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<faction, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(354n), v: f.assemblyList([355.25, 356.25, 357.25], 'float') },
      { k: new faction(356n), v: f.assemblyList([357.25, 358.25, 359.25], 'float') }
    ]),
    new faction(358n),
    f.assemblyList([359.25, 360.25, 361.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<faction, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(361n), v: f.assemblyList([362n, 363n, 364n], 'guid') },
      { k: new faction(363n), v: f.assemblyList([364n, 365n, 366n], 'guid') }
    ]),
    new faction(365n),
    f.assemblyList([366n, 367n, 368n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<faction, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(368n), v: f.assemblyList([369n, 370n, 371n], 'int') },
      { k: new faction(370n), v: f.assemblyList([371n, 372n, 373n], 'int') }
    ]),
    new faction(372n),
    f.assemblyList([373n, 374n, 375n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<faction, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(375n), v: f.assemblyList(['376', '377', '378'], 'str') },
      { k: new faction(377n), v: f.assemblyList(['378', '379', '380'], 'str') }
    ]),
    new faction(379n),
    f.assemblyList(['380', '381', '382'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(389n), v: new prefabId(390n) },
      { k: new faction(391n), v: new prefabId(392n) }
    ]),
    new faction(393n),
    new prefabId(394n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(396n), v: '397' },
      { k: new faction(398n), v: '399' }
    ]),
    new faction(400n),
    '401'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new faction(403n), v: [404, 405, 406] },
      { k: new faction(405n), v: [406, 407, 408] }
    ]),
    new faction(407n),
    [408, 409, 410]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(410n), v: true },
      { k: new guid(412n), v: true }
    ]),
    new guid(414n),
    true
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(417n), v: new configId(418n) },
      { k: new guid(419n), v: new configId(420n) }
    ]),
    new guid(421n),
    new configId(422n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(424n), v: f.getSelfEntity() },
      { k: new guid(426n), v: f.getSelfEntity() }
    ]),
    new guid(428n),
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(431n), v: new faction(432n) },
      { k: new guid(433n), v: new faction(434n) }
    ]),
    new guid(435n),
    new faction(436n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(438n), v: 439.25 },
      { k: new guid(440n), v: 441.25 }
    ]),
    new guid(442n),
    443.25
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(445n), v: new guid(446n) },
      { k: new guid(447n), v: new guid(448n) }
    ]),
    new guid(449n),
    new guid(450n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(452n), v: 453n },
      { k: new guid(454n), v: 455n }
    ]),
    new guid(456n),
    457n
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(459n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new guid(461n), v: f.assemblyList([false, true, false], 'bool') }
    ]),
    new guid(463n),
    f.assemblyList([false, true, false], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(466n), v: f.assemblyList([467n, 468n, 469n], 'config_id') },
      { k: new guid(468n), v: f.assemblyList([469n, 470n, 471n], 'config_id') }
    ]),
    new guid(470n),
    f.assemblyList([471n, 472n, 473n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(483n), v: f.assemblyList([484n, 485n, 486n], 'faction') },
      { k: new guid(485n), v: f.assemblyList([486n, 487n, 488n], 'faction') }
    ]),
    new guid(487n),
    f.assemblyList([488n, 489n, 490n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<guid, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(490n), v: f.assemblyList([491.25, 492.25, 493.25], 'float') },
      { k: new guid(492n), v: f.assemblyList([493.25, 494.25, 495.25], 'float') }
    ]),
    new guid(494n),
    f.assemblyList([495.25, 496.25, 497.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<guid, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(497n), v: f.assemblyList([498n, 499n, 500n], 'guid') },
      { k: new guid(499n), v: f.assemblyList([500n, 501n, 502n], 'guid') }
    ]),
    new guid(501n),
    f.assemblyList([502n, 503n, 504n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<guid, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(504n), v: f.assemblyList([505n, 506n, 507n], 'int') },
      { k: new guid(506n), v: f.assemblyList([507n, 508n, 509n], 'int') }
    ]),
    new guid(508n),
    f.assemblyList([509n, 510n, 511n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<guid, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(511n), v: f.assemblyList(['512', '513', '514'], 'str') },
      { k: new guid(513n), v: f.assemblyList(['514', '515', '516'], 'str') }
    ]),
    new guid(515n),
    f.assemblyList(['516', '517', '518'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(525n), v: new prefabId(526n) },
      { k: new guid(527n), v: new prefabId(528n) }
    ]),
    new guid(529n),
    new prefabId(530n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(532n), v: '533' },
      { k: new guid(534n), v: '535' }
    ]),
    new guid(536n),
    '537'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new guid(539n), v: [540, 541, 542] },
      { k: new guid(541n), v: [542, 543, 544] }
    ]),
    new guid(543n),
    [544, 545, 546]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 553n, v: new configId(554n) },
      { k: 555n, v: new configId(556n) }
    ]),
    557n,
    new configId(558n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 560n, v: f.getSelfEntity() },
      { k: 562n, v: f.getSelfEntity() }
    ]),
    564n,
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 567n, v: new faction(568n) },
      { k: 569n, v: new faction(570n) }
    ]),
    571n,
    new faction(572n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 581n, v: new guid(582n) },
      { k: 583n, v: new guid(584n) }
    ]),
    585n,
    new guid(586n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 595n, v: f.assemblyList([false, true, false], 'bool') },
      { k: 597n, v: f.assemblyList([false, true, false], 'bool') }
    ]),
    599n,
    f.assemblyList([false, true, false], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 602n, v: f.assemblyList([603n, 604n, 605n], 'config_id') },
      { k: 604n, v: f.assemblyList([605n, 606n, 607n], 'config_id') }
    ]),
    606n,
    f.assemblyList([607n, 608n, 609n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 619n, v: f.assemblyList([620n, 621n, 622n], 'faction') },
      { k: 621n, v: f.assemblyList([622n, 623n, 624n], 'faction') }
    ]),
    623n,
    f.assemblyList([624n, 625n, 626n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<int, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 626n, v: f.assemblyList([627.25, 628.25, 629.25], 'float') },
      { k: 628n, v: f.assemblyList([629.25, 630.25, 631.25], 'float') }
    ]),
    630n,
    f.assemblyList([631.25, 632.25, 633.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<int, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 633n, v: f.assemblyList([634n, 635n, 636n], 'guid') },
      { k: 635n, v: f.assemblyList([636n, 637n, 638n], 'guid') }
    ]),
    637n,
    f.assemblyList([638n, 639n, 640n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<int, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 640n, v: f.assemblyList([641n, 642n, 643n], 'int') },
      { k: 642n, v: f.assemblyList([643n, 644n, 645n], 'int') }
    ]),
    644n,
    f.assemblyList([645n, 646n, 647n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<int, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 647n, v: f.assemblyList(['648', '649', '650'], 'str') },
      { k: 649n, v: f.assemblyList(['650', '651', '652'], 'str') }
    ]),
    651n,
    f.assemblyList(['652', '653', '654'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 661n, v: new prefabId(662n) },
      { k: 663n, v: new prefabId(664n) }
    ]),
    665n,
    new prefabId(666n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: 675n, v: [676, 677, 678] },
      { k: 677n, v: [678, 679, 680] }
    ]),
    679n,
    [680, 681, 682]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(682n), v: true },
      { k: new prefabId(684n), v: true }
    ]),
    new prefabId(686n),
    true
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(689n), v: new configId(690n) },
      { k: new prefabId(691n), v: new configId(692n) }
    ]),
    new prefabId(693n),
    new configId(694n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(696n), v: f.getSelfEntity() },
      { k: new prefabId(698n), v: f.getSelfEntity() }
    ]),
    new prefabId(700n),
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(703n), v: new faction(704n) },
      { k: new prefabId(705n), v: new faction(706n) }
    ]),
    new prefabId(707n),
    new faction(708n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(710n), v: 711.25 },
      { k: new prefabId(712n), v: 713.25 }
    ]),
    new prefabId(714n),
    715.25
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(717n), v: new guid(718n) },
      { k: new prefabId(719n), v: new guid(720n) }
    ]),
    new prefabId(721n),
    new guid(722n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(724n), v: 725n },
      { k: new prefabId(726n), v: 727n }
    ]),
    new prefabId(728n),
    729n
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(731n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new prefabId(733n), v: f.assemblyList([false, true, false], 'bool') }
    ]),
    new prefabId(735n),
    f.assemblyList([false, true, false], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(738n), v: f.assemblyList([739n, 740n, 741n], 'config_id') },
      { k: new prefabId(740n), v: f.assemblyList([741n, 742n, 743n], 'config_id') }
    ]),
    new prefabId(742n),
    f.assemblyList([743n, 744n, 745n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(755n), v: f.assemblyList([756n, 757n, 758n], 'faction') },
      { k: new prefabId(757n), v: f.assemblyList([758n, 759n, 760n], 'faction') }
    ]),
    new prefabId(759n),
    f.assemblyList([760n, 761n, 762n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<prefabId, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(762n), v: f.assemblyList([763.25, 764.25, 765.25], 'float') },
      { k: new prefabId(764n), v: f.assemblyList([765.25, 766.25, 767.25], 'float') }
    ]),
    new prefabId(766n),
    f.assemblyList([767.25, 768.25, 769.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<prefabId, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(769n), v: f.assemblyList([770n, 771n, 772n], 'guid') },
      { k: new prefabId(771n), v: f.assemblyList([772n, 773n, 774n], 'guid') }
    ]),
    new prefabId(773n),
    f.assemblyList([774n, 775n, 776n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<prefabId, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(776n), v: f.assemblyList([777n, 778n, 779n], 'int') },
      { k: new prefabId(778n), v: f.assemblyList([779n, 780n, 781n], 'int') }
    ]),
    new prefabId(780n),
    f.assemblyList([781n, 782n, 783n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<prefabId, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(783n), v: f.assemblyList(['784', '785', '786'], 'str') },
      { k: new prefabId(785n), v: f.assemblyList(['786', '787', '788'], 'str') }
    ]),
    new prefabId(787n),
    f.assemblyList(['788', '789', '790'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(797n), v: new prefabId(798n) },
      { k: new prefabId(799n), v: new prefabId(800n) }
    ]),
    new prefabId(801n),
    new prefabId(802n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(804n), v: '805' },
      { k: new prefabId(806n), v: '807' }
    ]),
    new prefabId(808n),
    '809'
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: new prefabId(811n), v: [812, 813, 814] },
      { k: new prefabId(813n), v: [814, 815, 816] }
    ]),
    new prefabId(815n),
    [816, 817, 818]
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '825', v: new configId(826n) },
      { k: '827', v: new configId(828n) }
    ]),
    '829',
    new configId(830n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '832', v: f.getSelfEntity() },
      { k: '834', v: f.getSelfEntity() }
    ]),
    '836',
    f.getSelfEntity()
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '839', v: new faction(840n) },
      { k: '841', v: new faction(842n) }
    ]),
    '843',
    new faction(844n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '853', v: new guid(854n) },
      { k: '855', v: new guid(856n) }
    ]),
    '857',
    new guid(858n)
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '867', v: f.assemblyList([false, true, false], 'bool') },
      { k: '869', v: f.assemblyList([false, true, false], 'bool') }
    ]),
    '871',
    f.assemblyList([false, true, false], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '874', v: f.assemblyList([875n, 876n, 877n], 'config_id') },
      { k: '876', v: f.assemblyList([877n, 878n, 879n], 'config_id') }
    ]),
    '878',
    f.assemblyList([879n, 880n, 881n], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '891', v: f.assemblyList([892n, 893n, 894n], 'faction') },
      { k: '893', v: f.assemblyList([894n, 895n, 896n], 'faction') }
    ]),
    '895',
    f.assemblyList([896n, 897n, 898n], 'faction')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<str, list<float>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '898', v: f.assemblyList([899.25, 900.25, 901.25], 'float') },
      { k: '900', v: f.assemblyList([901.25, 902.25, 903.25], 'float') }
    ]),
    '902',
    f.assemblyList([903.25, 904.25, 905.25], 'float')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<str, list<guid>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '905', v: f.assemblyList([906n, 907n, 908n], 'guid') },
      { k: '907', v: f.assemblyList([908n, 909n, 910n], 'guid') }
    ]),
    '909',
    f.assemblyList([910n, 911n, 912n], 'guid')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<str, list<int>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '912', v: f.assemblyList([913n, 914n, 915n], 'int') },
      { k: '914', v: f.assemblyList([915n, 916n, 917n], 'int') }
    ]),
    '916',
    f.assemblyList([917n, 918n, 919n], 'int')
  )
  // setOrAddKeyValuePairsToDictionary :: dict<str, list<str>>
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '919', v: f.assemblyList(['920', '921', '922'], 'str') },
      { k: '921', v: f.assemblyList(['922', '923', '924'], 'str') }
    ]),
    '923',
    f.assemblyList(['924', '925', '926'], 'str')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    f.assemblyDictionary([
      { k: '933', v: new prefabId(934n) },
      { k: '935', v: new prefabId(936n) }
    ]),
    '937',
    new prefabId(938n)
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(12n), v: f.getSelfEntity() },
      { k: new configId(14n), v: f.getSelfEntity() }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(17n), v: new faction(18n) },
      { k: new configId(19n), v: new faction(20n) }
    ])
  )
  // clearDictionary :: dict<configId, float>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(22n), v: 23.25 },
      { k: new configId(24n), v: 25.25 }
    ])
  )
  // clearDictionary :: dict<configId, guid>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(27n), v: new guid(28n) },
      { k: new configId(29n), v: new guid(30n) }
    ])
  )
  // clearDictionary :: dict<configId, int>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(32n), v: 33n },
      { k: new configId(34n), v: 35n }
    ])
  )
  // clearDictionary :: dict<configId, list<bool>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(37n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new configId(39n), v: f.assemblyList([false, true, false], 'bool') }
    ])
  )
  // clearDictionary :: dict<configId, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(42n), v: f.assemblyList([43n, 44n, 45n], 'config_id') },
      { k: new configId(44n), v: f.assemblyList([45n, 46n, 47n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(54n), v: f.assemblyList([55n, 56n, 57n], 'faction') },
      { k: new configId(56n), v: f.assemblyList([57n, 58n, 59n], 'faction') }
    ])
  )
  // clearDictionary :: dict<configId, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(59n), v: f.assemblyList([60.25, 61.25, 62.25], 'float') },
      { k: new configId(61n), v: f.assemblyList([62.25, 63.25, 64.25], 'float') }
    ])
  )
  // clearDictionary :: dict<configId, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(64n), v: f.assemblyList([65n, 66n, 67n], 'guid') },
      { k: new configId(66n), v: f.assemblyList([67n, 68n, 69n], 'guid') }
    ])
  )
  // clearDictionary :: dict<configId, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(69n), v: f.assemblyList([70n, 71n, 72n], 'int') },
      { k: new configId(71n), v: f.assemblyList([72n, 73n, 74n], 'int') }
    ])
  )
  // clearDictionary :: dict<configId, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(74n), v: f.assemblyList(['75', '76', '77'], 'str') },
      { k: new configId(76n), v: f.assemblyList(['77', '78', '79'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(84n), v: new prefabId(85n) },
      { k: new configId(86n), v: new prefabId(87n) }
    ])
  )
  // clearDictionary :: dict<configId, str>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(89n), v: '90' },
      { k: new configId(91n), v: '92' }
    ])
  )
  // clearDictionary :: dict<configId, vec3>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new configId(94n), v: [95, 96, 97] },
      { k: new configId(96n), v: [97, 98, 99] }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new configId(105n) },
      { k: f.getSelfEntity(), v: new configId(107n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new faction(115n) },
      { k: f.getSelfEntity(), v: new faction(117n) }
    ])
  )
  // clearDictionary :: dict<entity, float>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 120.25 },
      { k: f.getSelfEntity(), v: 122.25 }
    ])
  )
  // clearDictionary :: dict<entity, guid>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new guid(125n) },
      { k: f.getSelfEntity(), v: new guid(127n) }
    ])
  )
  // clearDictionary :: dict<entity, int>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: 130n },
      { k: f.getSelfEntity(), v: 132n }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([140n, 141n, 142n], 'config_id') },
      { k: f.getSelfEntity(), v: f.assemblyList([142n, 143n, 144n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([152n, 153n, 154n], 'faction') },
      { k: f.getSelfEntity(), v: f.assemblyList([154n, 155n, 156n], 'faction') }
    ])
  )
  // clearDictionary :: dict<entity, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([157.25, 158.25, 159.25], 'float') },
      { k: f.getSelfEntity(), v: f.assemblyList([159.25, 160.25, 161.25], 'float') }
    ])
  )
  // clearDictionary :: dict<entity, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([162n, 163n, 164n], 'guid') },
      { k: f.getSelfEntity(), v: f.assemblyList([164n, 165n, 166n], 'guid') }
    ])
  )
  // clearDictionary :: dict<entity, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList([167n, 168n, 169n], 'int') },
      { k: f.getSelfEntity(), v: f.assemblyList([169n, 170n, 171n], 'int') }
    ])
  )
  // clearDictionary :: dict<entity, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: f.assemblyList(['172', '173', '174'], 'str') },
      { k: f.getSelfEntity(), v: f.assemblyList(['174', '175', '176'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: new prefabId(182n) },
      { k: f.getSelfEntity(), v: new prefabId(184n) }
    ])
  )
  // clearDictionary :: dict<entity, str>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: '187' },
      { k: f.getSelfEntity(), v: '189' }
    ])
  )
  // clearDictionary :: dict<entity, vec3>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: f.getSelfEntity(), v: [192, 193, 194] },
      { k: f.getSelfEntity(), v: [194, 195, 196] }
    ])
  )
  // clearDictionary :: dict<faction, bool>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(196n), v: true },
      { k: new faction(198n), v: true }
    ])
  )
  // clearDictionary :: dict<faction, configId>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(201n), v: new configId(202n) },
      { k: new faction(203n), v: new configId(204n) }
    ])
  )
  // clearDictionary :: dict<faction, entity>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(206n), v: f.getSelfEntity() },
      { k: new faction(208n), v: f.getSelfEntity() }
    ])
  )
  // clearDictionary :: dict<faction, faction>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(211n), v: new faction(212n) },
      { k: new faction(213n), v: new faction(214n) }
    ])
  )
  // clearDictionary :: dict<faction, float>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(216n), v: 217.25 },
      { k: new faction(218n), v: 219.25 }
    ])
  )
  // clearDictionary :: dict<faction, guid>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(221n), v: new guid(222n) },
      { k: new faction(223n), v: new guid(224n) }
    ])
  )
  // clearDictionary :: dict<faction, int>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(226n), v: 227n },
      { k: new faction(228n), v: 229n }
    ])
  )
  // clearDictionary :: dict<faction, list<bool>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(231n), v: f.assemblyList([false, true, false], 'bool') },
      { k: new faction(233n), v: f.assemblyList([false, true, false], 'bool') }
    ])
  )
  // clearDictionary :: dict<faction, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(236n), v: f.assemblyList([237n, 238n, 239n], 'config_id') },
      { k: new faction(238n), v: f.assemblyList([239n, 240n, 241n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(248n), v: f.assemblyList([249n, 250n, 251n], 'faction') },
      { k: new faction(250n), v: f.assemblyList([251n, 252n, 253n], 'faction') }
    ])
  )
  // clearDictionary :: dict<faction, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(253n), v: f.assemblyList([254.25, 255.25, 256.25], 'float') },
      { k: new faction(255n), v: f.assemblyList([256.25, 257.25, 258.25], 'float') }
    ])
  )
  // clearDictionary :: dict<faction, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(258n), v: f.assemblyList([259n, 260n, 261n], 'guid') },
      { k: new faction(260n), v: f.assemblyList([261n, 262n, 263n], 'guid') }
    ])
  )
  // clearDictionary :: dict<faction, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(263n), v: f.assemblyList([264n, 265n, 266n], 'int') },
      { k: new faction(265n), v: f.assemblyList([266n, 267n, 268n], 'int') }
    ])
  )
  // clearDictionary :: dict<faction, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(268n), v: f.assemblyList(['269', '270', '271'], 'str') },
      { k: new faction(270n), v: f.assemblyList(['271', '272', '273'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(278n), v: new prefabId(279n) },
      { k: new faction(280n), v: new prefabId(281n) }
    ])
  )
  // clearDictionary :: dict<faction, str>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(283n), v: '284' },
      { k: new faction(285n), v: '286' }
    ])
  )
  // clearDictionary :: dict<faction, vec3>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new faction(288n), v: [289, 290, 291] },
      { k: new faction(290n), v: [291, 292, 293] }
    ])
  )
  // clearDictionary :: dict<guid, bool>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(293n), v: false },
      { k: new guid(295n), v: false }
    ])
  )
  // clearDictionary :: dict<guid, configId>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(298n), v: new configId(299n) },
      { k: new guid(300n), v: new configId(301n) }
    ])
  )
  // clearDictionary :: dict<guid, entity>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(303n), v: f.getSelfEntity() },
      { k: new guid(305n), v: f.getSelfEntity() }
    ])
  )
  // clearDictionary :: dict<guid, faction>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(308n), v: new faction(309n) },
      { k: new guid(310n), v: new faction(311n) }
    ])
  )
  // clearDictionary :: dict<guid, float>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(313n), v: 314.25 },
      { k: new guid(315n), v: 316.25 }
    ])
  )
  // clearDictionary :: dict<guid, guid>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(318n), v: new guid(319n) },
      { k: new guid(320n), v: new guid(321n) }
    ])
  )
  // clearDictionary :: dict<guid, int>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(323n), v: 324n },
      { k: new guid(325n), v: 326n }
    ])
  )
  // clearDictionary :: dict<guid, list<bool>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(328n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new guid(330n), v: f.assemblyList([true, false, true], 'bool') }
    ])
  )
  // clearDictionary :: dict<guid, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(333n), v: f.assemblyList([334n, 335n, 336n], 'config_id') },
      { k: new guid(335n), v: f.assemblyList([336n, 337n, 338n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(345n), v: f.assemblyList([346n, 347n, 348n], 'faction') },
      { k: new guid(347n), v: f.assemblyList([348n, 349n, 350n], 'faction') }
    ])
  )
  // clearDictionary :: dict<guid, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(350n), v: f.assemblyList([351.25, 352.25, 353.25], 'float') },
      { k: new guid(352n), v: f.assemblyList([353.25, 354.25, 355.25], 'float') }
    ])
  )
  // clearDictionary :: dict<guid, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(355n), v: f.assemblyList([356n, 357n, 358n], 'guid') },
      { k: new guid(357n), v: f.assemblyList([358n, 359n, 360n], 'guid') }
    ])
  )
  // clearDictionary :: dict<guid, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(360n), v: f.assemblyList([361n, 362n, 363n], 'int') },
      { k: new guid(362n), v: f.assemblyList([363n, 364n, 365n], 'int') }
    ])
  )
  // clearDictionary :: dict<guid, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(365n), v: f.assemblyList(['366', '367', '368'], 'str') },
      { k: new guid(367n), v: f.assemblyList(['368', '369', '370'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(375n), v: new prefabId(376n) },
      { k: new guid(377n), v: new prefabId(378n) }
    ])
  )
  // clearDictionary :: dict<guid, str>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(380n), v: '381' },
      { k: new guid(382n), v: '383' }
    ])
  )
  // clearDictionary :: dict<guid, vec3>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new guid(385n), v: [386, 387, 388] },
      { k: new guid(387n), v: [388, 389, 390] }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 395n, v: new configId(396n) },
      { k: 397n, v: new configId(398n) }
    ])
  )
  // clearDictionary :: dict<int, entity>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 400n, v: f.getSelfEntity() },
      { k: 402n, v: f.getSelfEntity() }
    ])
  )
  // clearDictionary :: dict<int, faction>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 405n, v: new faction(406n) },
      { k: 407n, v: new faction(408n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 415n, v: new guid(416n) },
      { k: 417n, v: new guid(418n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 425n, v: f.assemblyList([false, true, false], 'bool') },
      { k: 427n, v: f.assemblyList([false, true, false], 'bool') }
    ])
  )
  // clearDictionary :: dict<int, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 430n, v: f.assemblyList([431n, 432n, 433n], 'config_id') },
      { k: 432n, v: f.assemblyList([433n, 434n, 435n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 442n, v: f.assemblyList([443n, 444n, 445n], 'faction') },
      { k: 444n, v: f.assemblyList([445n, 446n, 447n], 'faction') }
    ])
  )
  // clearDictionary :: dict<int, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 447n, v: f.assemblyList([448.25, 449.25, 450.25], 'float') },
      { k: 449n, v: f.assemblyList([450.25, 451.25, 452.25], 'float') }
    ])
  )
  // clearDictionary :: dict<int, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 452n, v: f.assemblyList([453n, 454n, 455n], 'guid') },
      { k: 454n, v: f.assemblyList([455n, 456n, 457n], 'guid') }
    ])
  )
  // clearDictionary :: dict<int, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 457n, v: f.assemblyList([458n, 459n, 460n], 'int') },
      { k: 459n, v: f.assemblyList([460n, 461n, 462n], 'int') }
    ])
  )
  // clearDictionary :: dict<int, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 462n, v: f.assemblyList(['463', '464', '465'], 'str') },
      { k: 464n, v: f.assemblyList(['465', '466', '467'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 472n, v: new prefabId(473n) },
      { k: 474n, v: new prefabId(475n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: 482n, v: [483, 484, 485] },
      { k: 484n, v: [485, 486, 487] }
    ])
  )
  // clearDictionary :: dict<prefabId, bool>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(487n), v: false },
      { k: new prefabId(489n), v: false }
    ])
  )
  // clearDictionary :: dict<prefabId, configId>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(492n), v: new configId(493n) },
      { k: new prefabId(494n), v: new configId(495n) }
    ])
  )
  // clearDictionary :: dict<prefabId, entity>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(497n), v: f.getSelfEntity() },
      { k: new prefabId(499n), v: f.getSelfEntity() }
    ])
  )
  // clearDictionary :: dict<prefabId, faction>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(502n), v: new faction(503n) },
      { k: new prefabId(504n), v: new faction(505n) }
    ])
  )
  // clearDictionary :: dict<prefabId, float>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(507n), v: 508.25 },
      { k: new prefabId(509n), v: 510.25 }
    ])
  )
  // clearDictionary :: dict<prefabId, guid>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(512n), v: new guid(513n) },
      { k: new prefabId(514n), v: new guid(515n) }
    ])
  )
  // clearDictionary :: dict<prefabId, int>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(517n), v: 518n },
      { k: new prefabId(519n), v: 520n }
    ])
  )
  // clearDictionary :: dict<prefabId, list<bool>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(522n), v: f.assemblyList([true, false, true], 'bool') },
      { k: new prefabId(524n), v: f.assemblyList([true, false, true], 'bool') }
    ])
  )
  // clearDictionary :: dict<prefabId, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(527n), v: f.assemblyList([528n, 529n, 530n], 'config_id') },
      { k: new prefabId(529n), v: f.assemblyList([530n, 531n, 532n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(539n), v: f.assemblyList([540n, 541n, 542n], 'faction') },
      { k: new prefabId(541n), v: f.assemblyList([542n, 543n, 544n], 'faction') }
    ])
  )
  // clearDictionary :: dict<prefabId, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(544n), v: f.assemblyList([545.25, 546.25, 547.25], 'float') },
      { k: new prefabId(546n), v: f.assemblyList([547.25, 548.25, 549.25], 'float') }
    ])
  )
  // clearDictionary :: dict<prefabId, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(549n), v: f.assemblyList([550n, 551n, 552n], 'guid') },
      { k: new prefabId(551n), v: f.assemblyList([552n, 553n, 554n], 'guid') }
    ])
  )
  // clearDictionary :: dict<prefabId, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(554n), v: f.assemblyList([555n, 556n, 557n], 'int') },
      { k: new prefabId(556n), v: f.assemblyList([557n, 558n, 559n], 'int') }
    ])
  )
  // clearDictionary :: dict<prefabId, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(559n), v: f.assemblyList(['560', '561', '562'], 'str') },
      { k: new prefabId(561n), v: f.assemblyList(['562', '563', '564'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(569n), v: new prefabId(570n) },
      { k: new prefabId(571n), v: new prefabId(572n) }
    ])
  )
  // clearDictionary :: dict<prefabId, str>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(574n), v: '575' },
      { k: new prefabId(576n), v: '577' }
    ])
  )
  // clearDictionary :: dict<prefabId, vec3>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: new prefabId(579n), v: [580, 581, 582] },
      { k: new prefabId(581n), v: [582, 583, 584] }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '589', v: new configId(590n) },
      { k: '591', v: new configId(592n) }
    ])
  )
  // clearDictionary :: dict<str, entity>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '594', v: f.getSelfEntity() },
      { k: '596', v: f.getSelfEntity() }
    ])
  )
  // clearDictionary :: dict<str, faction>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '599', v: new faction(600n) },
      { k: '601', v: new faction(602n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '609', v: new guid(610n) },
      { k: '611', v: new guid(612n) }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '619', v: f.assemblyList([false, true, false], 'bool') },
      { k: '621', v: f.assemblyList([false, true, false], 'bool') }
    ])
  )
  // clearDictionary :: dict<str, list<configId>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '624', v: f.assemblyList([625n, 626n, 627n], 'config_id') },
      { k: '626', v: f.assemblyList([627n, 628n, 629n], 'config_id') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '636', v: f.assemblyList([637n, 638n, 639n], 'faction') },
      { k: '638', v: f.assemblyList([639n, 640n, 641n], 'faction') }
    ])
  )
  // clearDictionary :: dict<str, list<float>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '641', v: f.assemblyList([642.25, 643.25, 644.25], 'float') },
      { k: '643', v: f.assemblyList([644.25, 645.25, 646.25], 'float') }
    ])
  )
  // clearDictionary :: dict<str, list<guid>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '646', v: f.assemblyList([647n, 648n, 649n], 'guid') },
      { k: '648', v: f.assemblyList([649n, 650n, 651n], 'guid') }
    ])
  )
  // clearDictionary :: dict<str, list<int>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '651', v: f.assemblyList([652n, 653n, 654n], 'int') },
      { k: '653', v: f.assemblyList([654n, 655n, 656n], 'int') }
    ])
  )
  // clearDictionary :: dict<str, list<str>>
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '656', v: f.assemblyList(['657', '658', '659'], 'str') },
      { k: '658', v: f.assemblyList(['659', '660', '661'], 'str') }
    ])
  )
  ...
  f.clearDictionary(
    f.assemblyDictionary([
      { k: '666', v: new prefabId(667n) },
      { k: '668', v: new prefabId(669n) }
    ])
  )
