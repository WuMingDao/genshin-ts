...
g.server({ id: 1073741933 }).on('whenEntityIsCreated', (_evt, f) => {
  ...
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: vConfig, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<configId, list<configId>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: vConfig, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<configId, list<entity>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([e, e, e], 'entity') },
    { k: vConfig, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<configId, list<faction>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: vConfig, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<configId, list<float>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: vConfig, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<configId, list<guid>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: vConfig, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<configId, list<int>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: vConfig, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<configId, list<str>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: vConfig, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<configId, list<vec3>>
  f.assemblyDictionary([
    { k: vConfig, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: vConfig, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<configId, prefabId>
  f.assemblyDictionary([
    { k: vConfig, v: new prefabId(1n) },
    { k: vConfig, v: new prefabId(1n) }
  ])
  ...
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: e, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<entity, list<configId>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: e, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<entity, list<entity>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([e, e, e], 'entity') },
    { k: e, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<entity, list<faction>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: e, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<entity, list<float>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: e, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<entity, list<guid>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: e, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<entity, list<int>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: e, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<entity, list<str>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: e, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<entity, list<vec3>>
  f.assemblyDictionary([
    { k: e, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: e, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<entity, prefabId>
  f.assemblyDictionary([
    { k: e, v: new prefabId(1n) },
    { k: e, v: new prefabId(1n) }
  ])
  ...
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: vFaction, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<faction, list<configId>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: vFaction, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<faction, list<entity>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([e, e, e], 'entity') },
    { k: vFaction, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<faction, list<faction>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: vFaction, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<faction, list<float>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: vFaction, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<faction, list<guid>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: vFaction, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<faction, list<int>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: vFaction, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<faction, list<str>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: vFaction, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<faction, list<vec3>>
  f.assemblyDictionary([
    { k: vFaction, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: vFaction, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<faction, prefabId>
  f.assemblyDictionary([
    { k: vFaction, v: new prefabId(1n) },
    { k: vFaction, v: new prefabId(1n) }
  ])
  ...
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: vGuid, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<guid, list<configId>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: vGuid, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<guid, list<entity>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([e, e, e], 'entity') },
    { k: vGuid, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<guid, list<faction>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: vGuid, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<guid, list<float>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: vGuid, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<guid, list<guid>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: vGuid, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<guid, list<int>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: vGuid, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<guid, list<str>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: vGuid, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<guid, list<vec3>>
  f.assemblyDictionary([
    { k: vGuid, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: vGuid, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<guid, prefabId>
  f.assemblyDictionary([
    { k: vGuid, v: new prefabId(1n) },
    { k: vGuid, v: new prefabId(1n) }
  ])
  ...
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: vInt, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<int, list<configId>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: vInt, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<int, list<entity>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([e, e, e], 'entity') },
    { k: vInt, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<int, list<faction>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: vInt, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<int, list<float>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: vInt, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<int, list<guid>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: vInt, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<int, list<int>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: vInt, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<int, list<str>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: vInt, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<int, list<vec3>>
  f.assemblyDictionary([
    { k: vInt, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: vInt, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<int, prefabId>
  f.assemblyDictionary([
    { k: vInt, v: new prefabId(1n) },
    { k: vInt, v: new prefabId(1n) }
  ])
  ...
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vBool },
    { k: new prefabId(1n), v: vBool }
  ])
  // assemblyDictionary :: dict<prefabId, configId>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vConfig },
    { k: new prefabId(1n), v: vConfig }
  ])
  // assemblyDictionary :: dict<prefabId, entity>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: e },
    { k: new prefabId(1n), v: e }
  ])
  // assemblyDictionary :: dict<prefabId, faction>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vFaction },
    { k: new prefabId(1n), v: vFaction }
  ])
  // assemblyDictionary :: dict<prefabId, float>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vFloat },
    { k: new prefabId(1n), v: vFloat }
  ])
  // assemblyDictionary :: dict<prefabId, guid>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vGuid },
    { k: new prefabId(1n), v: vGuid }
  ])
  // assemblyDictionary :: dict<prefabId, int>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vInt },
    { k: new prefabId(1n), v: vInt }
  ])
  // assemblyDictionary :: dict<prefabId, list<bool>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: new prefabId(1n), v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<prefabId, list<configId>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: new prefabId(1n), v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<prefabId, list<entity>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([e, e, e], 'entity') },
    { k: new prefabId(1n), v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<prefabId, list<faction>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: new prefabId(1n), v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<prefabId, list<float>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: new prefabId(1n), v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<prefabId, list<guid>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: new prefabId(1n), v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<prefabId, list<int>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: new prefabId(1n), v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<prefabId, list<str>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: new prefabId(1n), v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<prefabId, list<vec3>>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: new prefabId(1n), v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<prefabId, prefabId>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: new prefabId(1n) },
    { k: new prefabId(1n), v: new prefabId(1n) }
  ])
  // assemblyDictionary :: dict<prefabId, str>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vStr },
    { k: new prefabId(1n), v: vStr }
  ])
  // assemblyDictionary :: dict<prefabId, vec3>
  f.assemblyDictionary([
    { k: new prefabId(1n), v: vVec3 },
    { k: new prefabId(1n), v: vVec3 }
  ])
  ...
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vBool, vBool, vBool], 'bool') },
    { k: vStr, v: f.assemblyList([vBool, vBool, vBool], 'bool') }
  ])
  // assemblyDictionary :: dict<str, list<configId>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') },
    { k: vStr, v: f.assemblyList([vConfig, vConfig, vConfig], 'config_id') }
  ])
  // assemblyDictionary :: dict<str, list<entity>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([e, e, e], 'entity') },
    { k: vStr, v: f.assemblyList([e, e, e], 'entity') }
  ])
  // assemblyDictionary :: dict<str, list<faction>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') },
    { k: vStr, v: f.assemblyList([vFaction, vFaction, vFaction], 'faction') }
  ])
  // assemblyDictionary :: dict<str, list<float>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') },
    { k: vStr, v: f.assemblyList([vFloat, vFloat, vFloat], 'float') }
  ])
  // assemblyDictionary :: dict<str, list<guid>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') },
    { k: vStr, v: f.assemblyList([vGuid, vGuid, vGuid], 'guid') }
  ])
  // assemblyDictionary :: dict<str, list<int>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vInt, vInt, vInt], 'int') },
    { k: vStr, v: f.assemblyList([vInt, vInt, vInt], 'int') }
  ])
  // assemblyDictionary :: dict<str, list<str>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vStr, vStr, vStr], 'str') },
    { k: vStr, v: f.assemblyList([vStr, vStr, vStr], 'str') }
  ])
  // assemblyDictionary :: dict<str, list<vec3>>
  f.assemblyDictionary([
    { k: vStr, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') },
    { k: vStr, v: f.assemblyList([vVec3, vVec3, vVec3], 'vec3') }
  ])
  // assemblyDictionary :: dict<str, prefabId>
  f.assemblyDictionary([
    { k: vStr, v: new prefabId(1n) },
    { k: vStr, v: new prefabId(1n) }
  ])
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vBool, vBool, vBool], 'bool')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vConfig, vConfig, vConfig], 'config_id')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vFaction, vFaction, vFaction], 'faction')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vFloat, vFloat, vFloat], 'float')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vGuid, vGuid, vGuid], 'guid')
  )
  ...
  f.setOrAddKeyValuePairsToDictionary(
    ...
    vConfig,
    f.assemblyList([vVec3, vVec3, vVec3], 'vec3')
  )
